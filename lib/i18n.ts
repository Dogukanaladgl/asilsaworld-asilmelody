...
export const dictionary = {
  tr: {
    ...
    spaces: {
      ...
      items: [
        ...
        { key: "lamia", label: "Lamia Koleksiyonu" },
  ...
  en: {
    ...
    spaces: {
      ...
      items: [
        ...
        { key: "lamia", label: "Lamia Collection" },
  ...
  ja: {
    ...
    spaces: {
      eyebrow: "カテゴリー",
      title: "コレクションから探す",
      catalogNote: "2027最新カタログ — カテゴリーを選んでモデルをご覧ください。",
      catalogBadge: "{year} 最新カタログ",
      comingSoon: "近日公開",
  ...
  es: {
    ...
    spaces: {
      ...
      items: [
        ...
        { key: "lamia", label: "Colección Lamia" },
  ...
  ru: {
    ...
    spaces: {
      ...
      items: [
        ...
        { key: "lamia", label: "Коллекция Lamia" },
